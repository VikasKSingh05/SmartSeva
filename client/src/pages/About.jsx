  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 md:p-16 min-h-[60vh]">
      <section className="w-full max-w-3xl glass-card bg-[#181824]/80 dark:bg-[#232336]/90 rounded-2xl shadow-lg p-8 mb-10 text-center">
        <h1 className="text-4xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-[#03dac5] via-[#6F01Ec] to-[#03dac5] dark:text-white">About SmartSeva</h1>
        ...
        <p className="text-base md:text-lg text-gray-700 dark:text-[#e4e4e7] mb-2">
          SmartSeva is a blockchain-based crowdfunding platform designed to bring transparent, trustless, and community-driven funding to everyone. Built on Ethereum, SmartSeva leverages smart contracts to ensure every transaction, donation, and withdrawal is open, auditable, and secure.
        </p>
      </section>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
        ...
        <div className="glass-card bg-[#1e293b]/70 dark:bg-[#13131a]/80 p-6 rounded-xl shadow-lg">
          ...
          <p className="text-gray-700 dark:text-[#e4e4e7]">SmartSeva uses Ethereum smart contracts and Thirdweb SDK to provide secure, decentralized campaign creation, fundraising, and fund management. Every monetary flow can be linked and verified on-chain.</p>
        </div>
        <div className="glass-card bg-[#1e293b]/70 dark:bg-[#13131a]/80 p-6 rounded-xl shadow-lg">
      ...
      <section className="w-full max-w-3xl glass-card bg-[#25243f]/70 dark:bg-[#13131a]/80 rounded-2xl shadow-lg p-8 mt-10 text-center">
        ...
        <p className="text-gray-700 dark:text-[#e4e4e7]">We believe in decentralization, trustless collaboration, and putting the power into the hands of communities. By prioritizing transparency and accessibility, SmartSeva aims to reshape how people support causes and build a more equitable future.</p>
      </section>
    </div>
  );
};
